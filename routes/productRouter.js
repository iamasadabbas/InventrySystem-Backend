...
const { addProduct, addProductType, addProductCompany, addLocation, addProductLocation, getAllProduct, productRequest, getProductType } = require("../controllers/productController");
